      ...
      <Container maxWidth="md" sx={{ mt: 15 }}>
        <Stack alignItems="center">
          <Typography variant="h3" align="center">
            Replace cryptocurrency addresses with a human readable name on{" "}
        ...
        >
          <Stack flex={1} spacing={5}>
            <Typography variant="h4">
              To send cryptocurrency, all you need to know is the recipient’s
              NFT domain
            </Typography>
            <Typography variant="h4">
              Send bitcoin, ethereum, and any other cryptocurrency with just one
              domain
            </Typography>
            <Typography variant="h4">
